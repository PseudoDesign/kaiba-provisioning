// Package stableverifiersigning defines the narrow, public authorization
// contract used to sign exactly one stable-campaign Raspberry Pi 5 verifier
// boot image.
//
...
const (
	IntentSchemaV1Alpha1 = "kaiba.provisioning.rpi5-stable-campaign-verifier-signing-intent/v1alpha1"
	AuthorizationScope   = "stable_campaign_verifier_boot"
	MaxIntentBytes       = 64 * 1024

	intentDigestDomain     = "kaiba.provisioning.rpi5-stable-campaign-verifier-signing-intent.v1alpha1"
...
// Intent binds the exact unsigned verifier manifest, the reviewed public key,
