...
const (
	ApprovalSchemaV1Alpha1  = "kaiba.provisioning.rpi5-stable-campaign-verifier-signing-approval/v1alpha1"
	DecisionApproved        = "approved"
	MaxApprovalBytes        = 64 * 1024
	MaximumApprovalLifetime = 24 * time.Hour

	approvalDigestDomain = "kaiba.provisioning.rpi5-stable-campaign-verifier-signing-approval.v1alpha1"
)
