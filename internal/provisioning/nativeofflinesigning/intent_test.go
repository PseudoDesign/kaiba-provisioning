...
func TestIntentStrictCanonicalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{"duplicate", strings.Replace(valid, `"authorization_scope":"native_offline_boot"`, `"authorization_scope":"native_offline_boot","authorization_scope":"native_offline_boot"`, 1), "duplicated"},
